...
export type WorkshopStruct = { slots: BigNumberish };

export type WorkshopStructOutput = [number] & { slots: number };
...
export type WorkshopMintedEventFilter = TypedEventFilter<WorkshopMintedEvent>;
